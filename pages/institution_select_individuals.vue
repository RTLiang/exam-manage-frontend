<template>
    ...
    <el-container>
        <el-header>
            <div style="font-size: x-large;margin-top: 10px;">请选择报考 <b>{{ subject.name }}</b> 的考生</div>
            <div style="margin-top: 20;">报名截止时间：{{ subject.registrationDeadline }}</div>
        </el-header>
        <el-main>
            <div class="table-container">
                <el-table ref="table" :data="tableData" stripe border @selection-change="handleSelectionChange"
...
.el-table {
    width: 80%;
    /* set the table width to 80% of the container */
}
</style>